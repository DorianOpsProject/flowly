    ...
    <div className="h-full flex flex-col items-center">
      ...
      <div className="relative mb-10">
        <svg width="220" height="220" className="-rotate-90">
          <circle cx="110" cy="110" r="90" fill="none" stroke="#1f2937" strokeWidth="10" />
          <circle
            cx="110" cy="110" r="90"
            fill="none"
            stroke={c.ring}
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <span className="text-5xl font-bold font-mono text-white tracking-tight">{mins}:{secs}</span>
      ...
      <div className="flex gap-4 mb-8">
        ...
        <button
          onClick={toggle}
          className={`px-8 py-3 rounded-xl text-white font-semibold text-sm transition-all hover:scale-105 ${c.btn}`}
        >
      ...
      <div className="flex gap-6 mb-8">
        <div className="text-center bg-gray-800/60 rounded-xl px-6 py-3">
          <p className="text-2xl font-bold text-white">{sessions}</p>
          <p className="text-xs text-gray-400">Sessions aujourd&apos;hui</p>
        </div>
        <div className="text-center bg-gray-800/60 rounded-xl px-6 py-3">
          <p className="text-2xl font-bold text-white">{Math.round(sessions * 25)}m</p>
